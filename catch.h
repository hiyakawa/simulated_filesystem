...
namespace Catch {
    ...
    private:
        ...
        // need to deal with seeding the tests_main state.
...
namespace detail {
    ...
    // Transport for raw args (copied from tests_main args, or supplied via init list for testing)
    class Args {
        friend TokenStream;
...
int tests_main (int argc, char * const argv[]) {
#if !CATCH_ARC_ENABLED
